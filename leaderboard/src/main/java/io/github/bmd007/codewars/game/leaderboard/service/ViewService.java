...
import io.github.bmd007.codewars.game.leaderboard.exception.ServiceUnavailableException;
...
public class ViewService<E, M, I> {
    ...
    //**
    // Use this method for fetching all data ONLY if the assigned store is GLOBAL
    // **//
